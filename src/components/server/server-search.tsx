...
export const ServerSearch = ({data}: ServerSearchProps) => {
 ...
 const [open, setOpen] = useState(false);
  ...
  return (
    <>
      <button onClick={()=> setOpen(true)} className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 hover:dark:bg-zinc-700/50 transition">

...
export default function ApplicationLogo({ className, ...rest }: SVGAttributes<SVGElement>) {
  return (
    <svg {...rest} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={cn("w-12 h-12", className)}>
